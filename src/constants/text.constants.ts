export const BANNER_TEXT = {
  title: "Ось, що вона спекла — детальні рецепти українською",
  userGoal:
    'Ви тут, щоб надихнутись випічкою і класно приготувати її з першого разу за моїми рецептами, перевіреними часом, друзями та моєю пристрастю.',
